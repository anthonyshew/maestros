...
In a monorepo, we're building one respository that handles all of our applications. However, this doesn't mean we want to think of our monorepo as one giant chunk of code.
