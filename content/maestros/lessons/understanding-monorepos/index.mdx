...
## Interested in building a monorepo?

Awesome! You're in the right place. To find out more about the use cases for monorepos, visit ["When to use a monorepo"](/monorepos/understanding-monorepos/when-to-use) or ["When NOT to use a monorepo"](/monorepos/understanding-monorepos/when-not-to-use). If you're ready to start learning, [head to "The basics"](/monorepos/basics).
