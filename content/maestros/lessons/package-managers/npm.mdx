...
[npm](https://npmjs.com) was the first JavaScript package manager, setting the standard for all of the package managers that we have today. npm comes buncled with the Node.js runtime and is the default package manager for the JavaScript ecosystem and supports monorepos through workspaces.
