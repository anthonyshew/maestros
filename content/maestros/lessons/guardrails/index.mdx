...
**Note that a formatter is specifically for verifying and correcting whitespace.** It should run quickly and not be concerned with code logic or naming conventions.
