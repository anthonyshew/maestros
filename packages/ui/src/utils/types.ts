...
export type NextImageType = React.ForwardRefExoticComponent<Omit<React.DetailedHTMLProps<React.ImgHTMLAttributes<HTMLImageElement>, HTMLImageElement>, "alt" | "height" | "loading" | "ref" | "src" | "srcSet" | "width"> & React.RefAttributes<HTMLImageElement | null> & {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  src: any;
  alt: string;
