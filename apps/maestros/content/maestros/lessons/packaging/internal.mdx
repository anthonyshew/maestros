...
- One version: When installing to other workspaces within your repository, you'll use `"*"` (or `"*"` for pnpm). This means you'll always use whatever the current version of the code that is in your repository.
